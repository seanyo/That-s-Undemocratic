...
CREATE TABLE `meme` (
  ...
  `meme_hash` varchar(32) DEFAULT NULL,
  `meme_delete_hash` varchar(32) DEFAULT NULL,
  `meme_image` varchar(255) DEFAULT NULL,
  `meme_page` varchar(255) DEFAULT NULL,
  `meme_delete` varchar(255) DEFAULT NULL,
  `meme_small` varchar(255) DEFAULT NULL,
  `meme_large` varchar(255) DEFAULT NULL,
  `meme_rating` int(11) DEFAULT NULL,
